 ...
 */
class modGestionParc extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 300320;     // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'gestionparc';
        ...
        $this->config_page_url = "setup.php@gestionparc";
        ...
        $this->langfiles = array("gestionparc@gestionparc");
        ...
        */
        ...
        $this->boxes = array(
            0=>array('file'=>'box_gestionparc.php@gestionparc','note'=>'','enabledbydefaulton'=>'Home'),
        );         // List of boxes
        // Example:
        //$this->boxes=array(
